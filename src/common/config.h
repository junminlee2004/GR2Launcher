...
//   aspectRatioOverride: "16:9" (default) | "16:10" | "21:9" | "32:9"
//   resolutionOverride:  "Off" (default)  | "540p" | "720p" | "900p" | "1080p" |
//                        "1440p" | "2160p"/"4K" | "4320p"/"8K"
//   disableMotionBlur:   when true, the motion-blur post-process pass is skipped at game
//                        load by NOPing the two pass-registration calls in the render-
//                        graph builder. Independent of resolutionOverride.
...
// gr2fork: FPS counter overlay (Debug)
bool getShowFpsCounter();
void setShowFpsCounter(bool enable, bool is_game_specific = false);
// gr2fork: runtime-only state (not persisted)
bool getGameRunning();
