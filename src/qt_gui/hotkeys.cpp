...
Hotkeys::Hotkeys(std::shared_ptr<IpcClient> ipc_client, bool isGameRunning, QWidget* parent)
    ...
    KBButtonsList = {ui->fpsButtonKB,         ui->quitButtonKB,   ui->fullscreenButtonKB,
                     ...
                     // gr2fork additions
                     ui->mouseTouchpadButton, ui->mouseTouchpadSwipeButton};
...
void Hotkeys::SetDefault() {
    ...
    // gr2fork additions: unmapped by default. The user wires what they want.
...
void Hotkeys::LoadHotkeys() {
    ...
    while (std::getline(file, line)) {
        ...
        if (output_string.contains("hotkey_fullscreen")) {
            ...
            // gr2fork addition. Test BEFORE _touchpad below -- the shorter
            // string is a substring of this one and contains() would match.
