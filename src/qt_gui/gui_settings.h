...
// version manager: stripped (gr2fork uses auto-detect, see EmulatorPath).
// The section name + GetVersionExecutablePath() are kept for ABI/save-file
// continuity but no key constants are defined here anymore.
